      ...
      <section id="About" className="py-10 bg-gray-50 sm:py-16 lg:py-24">
        <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
          <div className="mx-auto text-left md:max-w-lg lg:max-w-2xl md:text-center">
            <h2 className="text-3xl font-bold leading-tight text-center text-black sm:text-4xl lg:text-4xl lg:leading-tight">
              Learn more{" "}
          ...
          <div className="grid grid-cols-1 mt-8 md:mt-20 gap-y-6 md:grid-cols-2 gap-x-10">
            ...
            <div>
              <p className="mt-4 text-lg text-gray-500">
                Passionate about innovation and determined to excel in my field, I am committed to pushing my limits to achieve professional excellence.{" "}
                <span className="text-gray-900">Meticulous</span>,{" "}
                <span className="text-gray-900">creative</span>, and always{" "}
                <span className="text-gray-900">seeking</span> new{" "}
                <span className="text-gray-900">challenges</span>, I turn ideas into concrete solutions with{" "}
                <span className="text-gray-900">precision</span> and{" "}
              ...
              <ul className="space-y-3 text-lg pt-2">
                <li>
                  ...
                  <span className="text-gray-700">Debz Kheireddine</span>
                </li>
                <li>
                  <span className="font-bold text-gray-900">Date of birth :</span>{" "}
                  <span className="text-gray-700">16 / 12 / 2001</span>
                </li>
                <li>
                  <span className="font-bold text-gray-900">Address :</span>{" "}
                  <span className="text-gray-700">Annaba, Algeria</span>
                </li>
                <li>
                  <span className="font-bold text-gray-900">Email :</span>{" "}
                  <span className="text-gray-700">Kheireddinedebz@gmail.com</span>
                </li>
                <li>
                  <span className="font-bold text-gray-900">Phone :</span>{" "}
                  <span className="text-gray-700">+213 696 566 905</span>
                </li>
                <li>
